...
module.exports.scheduleInterview = async function(req, res){
    ...
    try{
        ...
        //if company doesn't exits
        if(!existingCompany){
            const newCompany = await Company.create({
                name: company,
            });
            newCompany.student.push(obj);
            newCompany.save();
        } else {
            for (let student of existingCompany.student){
            ...
            existingCompany.student.push(obj);
        ...
        console.log('Interview Scheduled Succesfully');
...
module.exports.updateStatus = async function(req, res) {
    ...
    try{
        ...
        if(company){
            for(let std of company.student){
